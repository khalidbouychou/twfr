...
const Cat4 = ({ updateProgress, onCategoryComplete }) => {
  ...
  const questions = [
    {
      ...
      question: 'Expérience d\'investissement',
      type: 'radio',
      options: [
        { value: 'none', label: 'Aucune expérience' },
        { value: 'beginner', label: 'Débutant (moins de 2 ans)' },
        { value: 'intermediate', label: 'Intermédiaire (2-5 ans)' },
        { value: 'advanced', label: 'Avancé (plus de 5 ans)' },
        { value: 'expert', label: 'Expert (plus de 10 ans)' }
      ]
    },
    {
      id: 'marketFluctuations',
      question: 'Réactions face aux fluctuations du marché',
      type: 'radio',
      options: [
        { value: 'calm', label: 'Je reste calme' },
        { value: 'concerned', label: 'Je suis préoccupé' },
        { value: 'excited', label: 'Je vois des opportunités' },
        { value: 'indifferent', label: 'Je suis indifférent' },
        { value: 'strategic', label: 'Je réévalue ma stratégie' }
      ]
    },
    {
      id: 'confidenceLevel',
      question: 'Niveau de confiance dans les décisions d\'investissement',
      type: 'radio',
      options: [
        { value: 'low', label: 'Faible confiance' },
        { value: 'moderate', label: 'Confiance modérée' },
        { value: 'high', label: 'Haute confiance' },
        { value: 'veryHigh', label: 'Très haute confiance' },
        { value: 'expert', label: 'Confiance d\'expert' }
      ]
    },
    {
      id: 'suddenDrops',
      question: 'Comportement face aux baisses soudaines du marché',
      type: 'radio',
      options: [
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Profil Investisseur</h2>
        <p className="text-gray-300 text-sm md:text-base">Découvrir votre expérience d'investissement et préférences</p>
      ...
      <div className="mt-8 p-6 rounded-xl border" style={{ backgroundColor: 'rgba(137, 85, 159, 0.1)', borderColor: '#89559F' }}>
        ...
        <p className="text-gray-300 text-sm md:text-base">
          Mieux comprendre le profil investisseur pour recommander des solutions adaptées au comportement financier et au niveau d'expertise.
        </p>
