...
const Cat5 = ({ updateProgress, onCategoryComplete }) => {
  ...
  const questions = [
    {
      id: 'environmentalExclusion',
      question: 'Exclusion des entreprises à fort impact environnemental',
      type: 'radio',
      options: [
        { value: 'notImportant', label: 'Pas important pour moi' },
        { value: 'somewhatImportant', label: 'Assez important' },
        { value: 'veryImportant', label: 'Très important' },
        { value: 'essential', label: 'Essentiel' },
        { value: 'mandatory', label: 'Obligatoire' }
      ]
    },
    {
      id: 'inclusionPolicies',
      question: 'Importance des politiques d\'inclusion et d\'équité',
      type: 'radio',
      options: [
        { value: 'low', label: 'Faible importance' },
        { value: 'medium', label: 'Importance moyenne' },
        { value: 'high', label: 'Haute importance' },
        { value: 'critical', label: 'Critique' },
        { value: 'priority', label: 'Priorité absolue' }
      ]
    },
    {
      id: 'ethicalGovernance',
      question: 'Préférences pour les entreprises avec des pratiques de gouvernance éthiques',
      type: 'radio',
      options: [
        { value: 'noPreference', label: 'Aucune préférence' },
        { value: 'prefer', label: 'Je préfère' },
        { value: 'stronglyPrefer', label: 'Je préfère fortement' },
        { value: 'require', label: 'J\'exige cela' },
        { value: 'exclusive', label: 'Exclusivement ces entreprises' }
      ]
    }
  ];
